# Kartik Raikar — AI Engineer & Architect Portfolio
...
1. **AtlasOS (Autonomous AI Operating System)**
   ...
   - *Stack:* React 19, TypeScript, FastAPI, WebSockets, Multi-Agent.

2. **Atlas AI Resume ("Talk with my Resume.")**
...
- **Styling:** Custom Cyber Dark Glassmorphic Design System, TailwindCSS v4, OKLCH Color Space
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/kartik-012/Portfolio.git
   cd Portfolio
   ```
