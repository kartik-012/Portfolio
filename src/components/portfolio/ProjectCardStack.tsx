...
const CARDS: ProjectCard[] = [
  {
    ...
    metrics: [
      { label: "Environment", value: "Windowed OS" },
      { label: "Multi-Agent", value: "Autonomous" },
      { label: "Telemetry", value: "Realtime" },
    ],
  ...
  },
  {
    ...
    metrics: [
      { label: "RAG Engine", value: "Dual Vector" },
      { label: "Streaming", value: "SSE Live" },
      { label: "PDF Highlights", value: "Realtime" },
    ],
